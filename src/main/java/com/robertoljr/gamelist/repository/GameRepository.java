...
public interface GameRepository extends JpaRepository<Game, Long> {
    ...
    @Query(nativeQuery = true, value = """
            SELECT tb_games.id, tb_games.title, tb_games.release_year AS releaseYear, tb_games.img_url AS imgUrl, tb_games.short_description AS shortDescription, tb_game_list_belongings.position
            FROM tb_games
